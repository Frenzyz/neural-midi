...
function editorStateFromDialog(dialog: EditorResult, prev: SequenceState): SequenceState {
  return {
    ...
    stylePreset: dialog.stylePreset,
    tightenPhrasing: dialog.tightenPhrasing,
    seed: dialog.seed,
    ...
    regionExpression: dialog.regionExpression,
...
function buildGenerationParams(
  ...
  return {
    ...
    expression: useRegion ? dialog.regionExpression : dialog.expression,
    stylePreset: useRegion ? dialog.regionStylePreset : dialog.stylePreset,
    tightenPhrasing: useRegion ? dialog.regionTightenPhrasing : dialog.tightenPhrasing,
